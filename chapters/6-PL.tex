...
\begin{table}
	...
	\caption{Inflections of the Russian nominal declension (adapted from \citealt[26]{zaliznjak09}).}
\label{tab:6:1}
\end{table}
...
\begin{table}
	...
	\begin{small}
		\begin{tabular} {p{2.5cm} p{1cm} r r r} \midrule
		 ...
		 \end{tabular}
		 \end{small}
		 \caption{\textit{Model accuracy. Classification table for the minimal adequate model. (The table representation is based on \citealt{bresnan-etal})}.}
\label{tab:6:7}
\end{table}
...
\vspace{2mm}
\caption{\textit{Importance of factors in model: decrease in Akaike Information Criteri-on (AIC) if factor removed. (The table representation is based on \citealt{szmrecsanyi-2013})}.}\label{fig:6:5}
\end{figure}
